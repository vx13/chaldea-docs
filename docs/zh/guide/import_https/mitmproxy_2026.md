...
::: info 特别声明
1. **适用范围**：以下说明仅适用于本页面介绍的“FGO 登录数据自动化抓取工具（含 run.bat 及 fgo_cap.py）”。
2. **服务器支持**：本工具仅支持由 bilibili 运营的 **国服 (简体中文)** 和 **台服 (繁体中文)**。**不支持** 日服、韩服、美服。
3. **权属说明**：本工具及其配套说明不代表本站或 Chaldea 项目组的立场。
:::
